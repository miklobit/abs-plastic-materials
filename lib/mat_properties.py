...
mat_properties = {
  ...
  'ABS Plastic Trans-Blue':{
      'Color':[0.0, 0.42327, 0.7454, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Bright Orange':{
      'Color':[1.0, 0.31399, 0.0, 1.0],
      'Boost Value':0.33,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Clear':{
      'Color':[1.0, 0.98225, 0.94731, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Green':{
      'Color':[0.0, 0.53328, 0.08438, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Light Blue':{
      'Color':[0.38643, 0.85499, 1.0, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.3,
  },
  'ABS Plastic Trans-Light Green':{
      'Color':[0.88792, 1.0, 0.01229, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Orange':{
      'Color':[1.0, 0.47353, 0.12214, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Red':{
      'Color':[0.95597, 0.0, 0.0, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Yellow':{
      'Color':[1.0, 0.89627, 0.01681, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.005,
      'Fingerprints':0.25,
  },
  'ABS Plastic Trans-Yellowish Clear':{
      'Color':[0.87962, 0.8388, 0.73046, 1.0],
      'Boost Value':0.0,
      'Rough 1':0.015,
      'Fingerprints':0.25,
  },
